...
if __name__ == "__main__":
    ...
    parser.add_argument("--logs_root", type=str, default="checkpoints/logs_vinicius/test_linear", help="Root logs/test directory")
    parser.add_argument("--output_csv", type=str, default="final_results_linear.csv", help="Output CSV filename")
    
    args = parser.parse_args()
    
    list_of_combinations = [5, 6, 7, 8, 9]
