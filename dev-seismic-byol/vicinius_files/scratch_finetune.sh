...
for r in "${REPETITIONS[@]}"; do
    ...
    FLAGS="--pretrain_data scratch --finetune_data ${f} --num_epochs 50 --batch_size 8 --repetition ${r} --learning_rate 1e-5 --cap 1.0"
...
echo "pretrain: scratch; fine_tune_data: $f; repetition: $r"
nvidia-smi
