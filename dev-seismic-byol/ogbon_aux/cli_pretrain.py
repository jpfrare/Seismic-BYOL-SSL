...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_size', type=int, default=224, help='Input size (used for both height and width)')
    parser.add_argument('--dataset_name', type=str, default='seam_ai', help='Name of the dataset')
    parser.add_argument('--batch_size', type=int, default=8, help='Batch size')
    parser.add_argument('--num_epochs', type=int, default=20, help='Number of training epochs')
    parser.add_argument('--repetition', type=int, default=0, help='Repetition being run')
    parser.add_argument('--learning_rate', type=float, default=0.2, help='Models learning rate')
    parser.add_argument('--gpus', type=int, nargs='+', default=[0], help='List of GPU device indices to use')
