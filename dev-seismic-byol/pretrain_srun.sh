...
# Training flags
FLAGS=(
  "--repetition 0 --input_size 256 --batch_size 128 --dataset_name namss --num_epochs 125000"
  # "--repetition 0 --input_size 256 --batch_size 128 --dataset_name a700 --num_epochs 125000"
  # "--repetition 0 --input_size 256 --batch_size 256 --dataset_name namss --num_epochs 85000"
  # "--repetition 0 --input_size 256 --batch_size 256 --dataset_name a700 --num_epochs 85000"
)
